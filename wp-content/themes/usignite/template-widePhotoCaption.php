...
/*
Template Name: Wide Photo with Caption Template
*/
...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
	...
	<div class="contentBox shadow">
		<div id="primary" class="innerContentBox clearfix">
			<div class="pageImage clearfix">	
				<div class="setImageWidth"><?php 
					the_post_thumbnail('full');
				?>
				</div>
				<span><?php echo get_post_meta($post->ID, 'image-caption', true); ?></span>
			</div> <!-- End of pageImage div -->
				
			<h2><?php echo get_post_meta($post->ID, "Sub-Headline", true); ?></h2>
				
			<div class="pullquote">
				<blockquote><span><?php echo get_post_meta($post->ID, "Pull Quote", true); ?></span></blockquote>
			</div>
